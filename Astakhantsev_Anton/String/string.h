...
public:
    ...
    String(const char* string) : str(new char[strlen(string)]), size(strlen(string)), buffer(strlen(string)) {
    ...
    size_t find(const String& substring) const {
        return find(substring, true);
    }

    size_t rfind(const String& substring) const {
        return find(substring, false);
    }
